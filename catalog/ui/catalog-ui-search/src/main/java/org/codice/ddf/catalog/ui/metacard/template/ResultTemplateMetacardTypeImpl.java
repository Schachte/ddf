...
public class ResultTemplateMetacardTypeImpl implements MetacardType {
  private static final Set<AttributeDescriptor> ATTRIBUTE_DESCRIPTORS =
      ImmutableSet.of(
              new CoreAttributes(), new SecurityAttributes(), new ResultTemplateAttributes())
          .stream()
  ...
  public String getName() {
    return ResultTemplateAttributes.NAME;
  }
