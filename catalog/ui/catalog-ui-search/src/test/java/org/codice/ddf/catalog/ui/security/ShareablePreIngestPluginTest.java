...
public class ShareablePreIngestPluginTest {
  ...
  private ShareablePreIngestPlugin makePlugin(Map<String, SortedSet<String>> attrs) {
    Subject subject = mock(Subject.class);

    return new ShareablePreIngestPlugin(subjectIdentity) {
      @Override
  ...
  public void testCreateShouldIgnoreNonShareableMetacards() throws Exception {
    ShareablePreIngestPlugin wpip = makePlugin(ImmutableMap.of());
  ...
  public void testCreateShareableSuccess() throws Exception {
    ...
    ShareablePreIngestPlugin wpip = makePlugin(attrs);
