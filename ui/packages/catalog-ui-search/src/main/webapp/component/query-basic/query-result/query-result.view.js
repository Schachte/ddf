...
module.exports = Marionette.LayoutView.extend({
        ...
        handleAttributeValue: function () {
            let attribute = this.basicAttribute.currentView.model.getValue()[0];
        ...
        edit: function () {
            ...
            let tabbable = _.filter(this.$el.find('[tabindex], input, button'), function (element) {
        ...
        setDefaultTitle: function(){
            let text = this.basicText.currentView.model.getValue()[0];
            let title;
            if (text === "") {
                title = "Result";
            } else {
